	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			// thus, always call a controller method to operate on the data
				...
				controller.setAdditionFields(first, second, third); 
				controller.addResult(first, second, third);
			}
		...
		// set "number" attribute to the model reference
		// the JSP will reference the model elements through "number"
